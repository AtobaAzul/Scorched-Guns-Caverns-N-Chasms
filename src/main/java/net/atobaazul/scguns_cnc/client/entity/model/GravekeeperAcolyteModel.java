...
public class GravekeeperAcolyteModel extends GeoModel<GravekeeperAcolyteEntity> {
    private final ResourceLocation model = new ResourceLocation(MOD_ID, "geo/entity/gravekeeper_ghoul.geo.json");
    private final ResourceLocation texture = new ResourceLocation(MOD_ID, "textures/entity/gravekeeper_acolyte.png");
    private final ResourceLocation animations = new ResourceLocation(MOD_ID, "animations/entity/gravekeeper_ghoul.animation.json");


    @Override
    public ResourceLocation getModelResource(GravekeeperAcolyteEntity GravekeeperAcolyteEntity) {
        return this.model;
    }

    @Override
    public ResourceLocation getTextureResource(GravekeeperAcolyteEntity GravekeeperAcolyteEntity) {
        return this.texture;
    }

    @Override
    public ResourceLocation getAnimationResource(GravekeeperAcolyteEntity GravekeeperAcolyteEntity) {
        return this.animations;
    }

    @Override
    public void setCustomAnimations(GravekeeperAcolyteEntity animatable, long instanceId, AnimationState<GravekeeperAcolyteEntity> animationState) {
