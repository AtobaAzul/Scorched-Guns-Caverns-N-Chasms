...
public class GravekeeperSchismModel extends GeoModel<GravekeeperSchismEntity> {
    private final ResourceLocation model = new ResourceLocation(MOD_ID, "geo/entity/gravekeeper_neophyte.geo.json");
    private final ResourceLocation texture = new ResourceLocation(MOD_ID, "textures/entity/gravekeeper_schism.png");
    ...
    @Override
    public ResourceLocation getModelResource(GravekeeperSchismEntity gravekeeperNeophyteEntity) {
        return this.model;
    }

    @Override
    public ResourceLocation getTextureResource(GravekeeperSchismEntity gravekeeperNeophyteEntity) {
        return this.texture;
    }

    @Override
    public ResourceLocation getAnimationResource(GravekeeperSchismEntity gravekeeperNeophyteEntity) {
        return this.animations;
    }

    @Override
    public void setCustomAnimations(GravekeeperSchismEntity animatable, long instanceId, AnimationState<GravekeeperSchismEntity> animationState) {
