...
public class GravekeeperGhoulEntity extends GravekeeperGunnerEntity implements GeoAnimatable, GeoEntity {
    ...
    public static AttributeSupplier setAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 30D).add(Attributes.ATTACK_DAMAGE, 3.0f).add(Attributes.ARMOR, 5f).add(Attributes.MOVEMENT_SPEED, 0.15f).add(Attributes.ATTACK_SPEED, 1.0f).build();
    }
